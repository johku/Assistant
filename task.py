...
class Task:
    def __init__(self, task_id, task_text, task_datetime, task_repeats, task_repeat_interval=0, task_repeat_added=False, task_reminder_added=False):
        self.task_id = task_id
        self.task_text = task_text
        self.task_datetime = task_datetime
        self.task_repeats = task_repeats
        self.task_repeat_interval = task_repeat_interval
        self.task_repeat_added = task_repeat_added
        self.task_reminder_added = task_reminder_added
